...
-- SQL statement 45: Add bbox geometry column >>>
/*
 * SQL statement name: 	add_geometry_column2.sql
 * Type:				Microsoft SQL Server T/sql anonymous block
 * Parameters:
...
-- SQL statement 47: Comment geometry table >>>
DECLARE @CurrentUser sysname
DECLARE @columnName  sysname 
DECLARE @tableName   sysname  /*
 * SQL statement name: 	comment_table.sql
...
-- SQL statement 55: Create load geometry view >>>
...
-- SQL statement 56: Load geometry table from CSV file >>>
...
-- SQL statement 57: Drop load geometry view >>>
...
-- SQL statement 63: Create spatial index on bbox >>>
/*
 * SQL statement name: 	create_spatial_geometry_index.sql
 * Type:				MS SQL Server SQL statement
 * Parameters:
...
-- SQL statement 64: Analyze table >>>
UPDATE STATISTICS rif_data.geometry_sahsuland;
GO

-- SQLCMD statement 65: Set comment schema path to rif_data >>>
:SETVAR SchemaName @CurrentUser

-- SQL statement 66: Remove old geolevels meta data table >>>
DELETE FROM t_rif40_geolevels WHERE geography = 'SAHSULAND';
GO

-- SQL statement 67: Remove old geography meta data table >>>
DELETE FROM rif40_geographies WHERE geography = 'SAHSULAND';
GO

-- SQL statement 68: Setup geography meta data table column: geometrytable >>>
/*
 * SQL statement name: 	add_column.sql
...
-- SQL statement 69: Comment geography meta data table columngeometrytable >>>
DECLARE @CurrentUser sysname
DECLARE @columnName  sysname 
DECLARE @tableName   sysname  /*
 * SQL statement name: 	comment_column.sql
...
-- SQL statement 70: Setup geography meta data table column: tiletable >>>
/*
 * SQL statement name: 	add_column.sql
 * Type:				Microsoft SQL Server SQL statement
 * Parameters:
...
-- SQL statement 71: Comment geography meta data table columntiletable >>>
DECLARE @CurrentUser sysname
DECLARE @columnName  sysname 
DECLARE @tableName   sysname  /*
 * SQL statement name: 	comment_column.sql
...
-- SQL statement 72: Setup geography meta data table column: minzoomlevel >>>
/*
 * SQL statement name: 	add_column.sql
 * Type:				Microsoft SQL Server SQL statement
 * Parameters:
...
-- SQL statement 73: Comment geography meta data table columnminzoomlevel >>>
DECLARE @CurrentUser sysname
DECLARE @columnName  sysname 
DECLARE @tableName   sysname  /*
 * SQL statement name: 	comment_column.sql
...
-- SQL statement 74: Setup geography meta data table column: maxzoomlevel >>>
/*
 * SQL statement name: 	add_column.sql
 * Type:				Microsoft SQL Server SQL statement
 * Parameters:
...
-- SQL statement 75: Comment geography meta data table columnmaxzoomlevel >>>
DECLARE @CurrentUser sysname
DECLARE @columnName  sysname 
DECLARE @tableName   sysname  /*
 * SQL statement name: 	comment_column.sql
...
-- SQL statement 76: Setup geolevels meta data table column: areaid_count >>>
/*
 * SQL statement name: 	add_column.sql
 * Type:				Microsoft SQL Server SQL statement
 * Parameters:
...
-- SQL statement 77: Comment geolevels meta data table columnareaid_count >>>
DECLARE @CurrentUser sysname
DECLARE @columnName  sysname 
DECLARE @tableName   sysname  /*
 * SQL statement name: 	comment_column.sql
...
-- SQLCMD statement 78: Set comment schema path to rif_data >>>
:SETVAR SchemaName "rif_data"

-- SQL statement 79: Populate geography meta data table >>>
/*
...
-- SQL statement 80: Insert geolevels meta data for: sahsu_grd_level1 >>>
/*
...
-- SQL statement 81: Create (if required) geolevels covariate table for: sahsu_grd_level2 >>>
/*
...
-- SQL statement 85: Insert geolevels meta data for: sahsu_grd_level2 >>>
/*
 * SQL statement name: 	insert_geolevel.sql
 * Type:				Common SQL statement
 * Parameters:
...
-- SQL statement 86: Create (if required) geolevels covariate table for: sahsu_grd_level3 >>>
/*
 * SQL statement name: 	create_covariate_table.sql
 * Type:				Microsoft SQL Server SQL statement
 * Parameters:
...
-- SQL statement 90: Insert geolevels meta data for: sahsu_grd_level3 >>>
/*
 * SQL statement name: 	insert_geolevel.sql
 * Type:				Common SQL statement
 * Parameters:
...
-- SQL statement 91: Create (if required) geolevels covariate table for: sahsu_grd_level4 >>>
/*
 * SQL statement name: 	create_covariate_table.sql
 * Type:				Microsoft SQL Server SQL statement
 * Parameters:
...
-- SQL statement 95: Insert geolevels meta data for: sahsu_grd_level4 >>>
/*
 * SQL statement name: 	insert_geolevel.sql
 * Type:				Common SQL statement
 * Parameters:
...
-- SQL statement 97: Drop dependent object - view tiles_sahsuland >>>
...
-- SQL statement 99: Drop generate_series() function >>>
/*
...
-- SQL statement 100: Create generate_series() function >>>
/*
...
-- SQL statement 102: Create function: longitude2tile.sql >>>
/*
...
-- SQL statement 103: Create function: latitude2tile.sql >>>
/*
...
-- SQL statement 104: Create function: tile2longitude.sql >>>
/*
...
-- SQL statement 105: Create function: tile2latitude.sql >>>
/*
...
-- SQL statement 109: Comment tiles table >>>
DECLARE @CurrentUser sysname
DECLARE @columnName  sysname 
DECLARE @tableName   sysname  /*
 * SQL statement name: 	comment_table.sql
