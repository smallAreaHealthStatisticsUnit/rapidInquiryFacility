...
REM Description:
REM
REM Rapid Enquiry Facility (RIF) - RIF40 log error handling batch file
REM
REM Copyright:
REM
...
REM
REM Usage: recreate_error_handling.bat
REM
REM MUST BE RUN AS ADMINSTRATOR
REM
sqlcmd -d sahsuland_dev -b -m-1 -e -i ..\sahsuland_dev\error_handling\recreate_error_handling.sql
