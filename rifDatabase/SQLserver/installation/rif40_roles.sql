...
-- RIF40: Schema owner
--
IF NOT EXISTS (SELECT * FROM sys.sql_logins WHERE name = N'rif40')
CREATE LOGIN [rif40] WITH PASSWORD='rif40', CHECK_POLICY = OFF;	-- Change this password if your SQL Server database is networked!
GO

--
-- RIFUSER: Test user
--
IF NOT EXISTS (SELECT name FROM sys.server_principals WHERE name = N'rifuser')
...
--
IF NOT EXISTS (SELECT name FROM sys.server_principals WHERE name = N'rifmanager')
