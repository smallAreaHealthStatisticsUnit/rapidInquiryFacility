...
REM Description:
REM
REM Rapid Enquiry Facility (RIF) - RIF40 sequences creation batch file
REM
REM Copyright:
REM
...
REM
REM Usage: recreate_all_sequences.bat
REM
REM MUST BE RUN AS ADMINSTRATOR
REM
sqlcmd -d sahsuland_dev -b -m-1 -e -i ..\sahsuland_dev\rif40\sequences\recreate_all_sequences.sql
