...
REM Description:
REM
REM Rapid Enquiry Facility (RIF) - RIF40 table triggers creation batch file
REM
REM Copyright:
REM
...
REM
REM Usage: rif40_install_table_triggers.bat
REM
REM MUST BE RUN AS ADMINSTRATOR
REM
sqlcmd -d sahsuland_dev -b -m-1 -e -i ..\sahsuland_dev\rif40\table_triggers\recreate_table_triggers.sql
