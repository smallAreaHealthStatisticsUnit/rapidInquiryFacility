...
REM Description:
REM
REM Rapid Enquiry Facility (RIF) - RIF40 functions creation batch file
REM
REM Copyright:
REM
...
REM
REM Usage: recreate_all_functions.bat
REM
...
sqlcmd -d sahsuland_dev -b -m-1 -e -i ..\sahsuland_dev\rif40\functions\recreate_all_functions.sql
