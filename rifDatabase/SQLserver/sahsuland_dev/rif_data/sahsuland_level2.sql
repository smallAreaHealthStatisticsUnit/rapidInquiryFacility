...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Artifical primary key for RIF web interface', @level0type=N'SCHEMA',@level0name=N'rif_data', @level1type=N'TABLE',@level1name=N'sahsuland_level2', @level2type=N'COLUMN',@level2name=N'gid'
GO
