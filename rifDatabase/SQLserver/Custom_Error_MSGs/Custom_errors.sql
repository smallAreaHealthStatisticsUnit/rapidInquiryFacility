...
EXEC sp_addmessage 50050, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] , T_RIF40_INVESTIGATIONS : Not a numerator table:(%s)';
GO

EXEC sp_addmessage 50051, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] , Entred table name year start is before RIF40_TABLES year start:(%s)';
GO

EXEC sp_addmessage 50052, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] , Entred table name year STOP is AFTER RIF40_TABLES year STOP:(%s)';
GO

EXEC sp_addmessage 50053, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] , Entered  min age group before RIF40_TABLES min age group :(%s)';
GO

EXEC sp_addmessage 50054, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] ,  no age group linkage :(%s)';
GO

EXEC sp_addmessage 50055, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] ,  Entered min age group is after max age group:(%s)';
GO
EXEC sp_addmessage 50056, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] , Entered  year start is after year stop:(%s)';
GO

EXEC sp_addmessage 50057, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] , Sex field column does not exist in the numerator table  :(%s)';
GO

EXEC sp_addmessage 50058, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] , Age group field column does not exist in the numerator table  :(%s)';
GO

EXEC sp_addmessage 50059, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] , Age sex group field column does not exist in the numerator table  :(%s)';
GO

EXEC sp_addmessage 50060, 16, 
   N'Table_name: [dbo].[T_RIF40_INVESTIGATIONS] , Age group ID mismatched  :(%s)';
...
EXEC sp_addmessage 50075, 16, 
   N'Table_name: [dbo].[T_RIF40_NUM_DENOM] , These numerator table/s do not exist:(%s)';
GO

EXEC sp_addmessage 50076, 16, 
   N'Table_name: [dbo].[T_RIF40_NUM_DENOM] , These are not numerator table/s :(%s)';
GO

EXEC sp_addmessage 50077, 16, 
   N'Table_name: [dbo].[T_RIF40_NUM_DENOM] , These denominator table/s do not exist :(%s)';
GO

EXEC sp_addmessage 50078, 16, 
   N'Table_name: [dbo].[T_RIF40_NUM_DENOM] , These are not denominator table/s :(%s)';
GO
