...
--     				  Get bounding box Y max, X max, Y min, X min for <geography> <geolevel view> <study>
--
-- Copyright:
--
...
CREATE OR REPLACE FUNCTION rif40_xml_pkg.rif40_getGeoLevelFullExtentForStudy(
	l_geography 	VARCHAR,
...
Parameters:	Geography, geolevel_view, study ID
...
e.g. SELECT rif40_xml_pkg.rif40_getGeoLevelFullExtentForStudy('SAHSU', 'LEVEL4', 1);

 rif40_getgeolevelfullextentforstudy
-------------------------------------
...
--
	IF NOT rif40_sql_pkg.is_rif40_user_manager_or_schema() THEN
		PERFORM rif40_log_pkg.rif40_error(-50000, 'rif40_getGeoLevelFullExtentForStudy', 
	...
	c1_rec:=rif40_xml_pkg._rif40_getGeoLevelExtentCommon(l_geography, l_geolevel_view, 
		NULL /* map area (single <geolevel view> area id) */, l_study_id /* or, study id */);
--
...
COMMENT ON FUNCTION rif40_xml_pkg.rif40_getGeoLevelFullExtentForStudy(VARCHAR, VARCHAR, INTEGER,
	OUT REAL, OUT REAL, OUT REAL, OUT REAL) IS 'Function: 	rif40_getGeoLevelFullExtentForStudy()
...
GRANT EXECUTE ON FUNCTION rif40_xml_pkg.rif40_getGeoLevelFullExtentForStudy(VARCHAR, VARCHAR, INTEGER,
