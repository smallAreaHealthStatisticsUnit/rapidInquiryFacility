...
COMMENT ON COLUMN rif40.rif40_numerator_outcome_columns.multiple_field_count IS 'Outcome Group multiple field count (0-99). E.g if NULL then field is ICD_SAHSU_01; if 20 then fields are ICD_SAHSU_01 to ICD_SAHSU_20. Field numbers are assumed to be left padded to 2 characters with "0" and preceeded by an underscore';
