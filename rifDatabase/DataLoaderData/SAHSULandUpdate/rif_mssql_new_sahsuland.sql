...
-- Description:
--
-- Rapid Enquiry Facility (RIF) - SQL Server script to load new extended SAHSULAND data
--
-- Copyright:
--
...
--
-- Usage: sqlcmd -U rif40 -d <database name> -b -m-1 -e -r1 -i rif_mssql_new_sahsuland.sql -v pwd="%cd%"
...
GO
BULK INSERT rif_data.covar_sahsuland_covariates3
FROM '$(pwd)/covar_sahsuland_covariates3_extended.csv'	-- Note use of pwd; set via -v pwd="%cd%" in the sqlcmd command line
WITH
(
	FIRSTROW = 2,
...
GO
BULK INSERT rif_data.covar_sahsuland_covariates4
FROM '$(pwd)/covar_sahsuland_covariates4_extended.csv'	-- Note use of pwd; set via -v pwd="%cd%" in the sqlcmd command line
WITH
(
	FIRSTROW = 2,
...
GO
BULK INSERT rif_data.num_sahsuland_cancer
FROM '$(pwd)/num_sahsuland_cancer_extended.csv'	-- Note use of pwd; set via -v pwd="%cd%" in the sqlcmd command line
WITH
(
	FIRSTROW = 2,
...
ALTER INDEX num_sahsuland_cancer_year ON rif_data.num_sahsuland_cancer REBUILD;
ALTER INDEX num_sahsuland_cancer_age_sex_group ON rif_data.num_sahsuland_cancer REBUILD;
ALTER INDEX num_sahsuland_cancer_sahsu_grd_level1 ON rif_data.num_sahsuland_cancer REBUILD;
ALTER INDEX num_sahsuland_cancer_sahsu_grd_level2 ON rif_data.num_sahsuland_cancer REBUILD;
ALTER INDEX num_sahsuland_cancer_sahsu_grd_level3 ON rif_data.num_sahsuland_cancer REBUILD;
ALTER INDEX num_sahsuland_cancer_sahsu_grd_level4 ON rif_data.num_sahsuland_cancer REBUILD;
ALTER INDEX num_sahsuland_cancer_total ON rif_data.num_sahsuland_cancer REBUILD;
GO
...
GO
BULK INSERT rif_data.pop_sahsuland_pop
FROM '$(pwd)/pop_sahsuland_pop_extended.csv'	-- Note use of pwd; set via -v pwd="%cd%" in the sqlcmd command line
WITH
(
	FIRSTROW = 2,
...
ALTER INDEX pop_sahsuland_pop_year ON rif_data.pop_sahsuland_pop REBUILD;
ALTER INDEX pop_sahsuland_pop_age_sex_group ON rif_data.pop_sahsuland_pop REBUILD;
ALTER INDEX pop_sahsuland_pop_sahsu_grd_level1 ON rif_data.pop_sahsuland_pop REBUILD;
ALTER INDEX pop_sahsuland_pop_sahsu_grd_level2 ON rif_data.pop_sahsuland_pop REBUILD;
ALTER INDEX pop_sahsuland_pop_sahsu_grd_level3 ON rif_data.pop_sahsuland_pop REBUILD;
ALTER INDEX pop_sahsuland_pop_sahsu_grd_level4 ON rif_data.pop_sahsuland_pop REBUILD;
ALTER INDEX pop_sahsuland_pop_total ON rif_data.pop_sahsuland_pop REBUILD;
GO
...
-- Analyse tables
--
UPDATE STATISTICS rif_data.pop_sahsuland_pop;
UPDATE STATISTICS rif_data.num_sahsuland_cancer;
UPDATE STATISTICS rif_data.covar_sahsuland_covariates3;
UPDATE STATISTICS rif_data.covar_sahsuland_covariates4;
GO
