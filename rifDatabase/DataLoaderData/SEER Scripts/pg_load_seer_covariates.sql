...
-- Description:
--
-- Rapid Enquiry Facility (RIF) - Load SEER covariate data; reformat into RIF4.0 format. Does not load into RIF (see rif40_load_seer.sql)
--                                Postgres script
--
--
-- Copyright:
...
-- Peter Hambly, SAHSU
--
-- Usage: psql -w -e -f pg_load_seer_covariates.sql
...
COMMENT ON COLUMN saipe_county_poverty_1989_2015.med_pct_not_in_pov_5_17r_quin IS 'Quintile: estimated percent of related children age 5-17 in families NOT in poverty (1=most deprived, 5=least)';
...
COMMENT ON COLUMN seer_wbo_ethnicity.ethnicity IS 'Ethnicity coded 1X: White; 2X: Black, 3X: American Indian/Alaska Native, 4X: Asian or Pacific Islander (1992 onwards); 99: Other (1973-1991); all with no hispanic data ';
...
-- Table: cov_cb_2014_us_county_500k
...
\dS+ cov_cb_2014_us_county_500k
 
-- Table: cov_cb_2014_us_state_500k

DROP TABLE IF EXISTS :USER.cov_cb_2014_us_state_500k;

CREATE TABLE cov_cb_2014_us_state_500k
(
  year integer NOT NULL, -- Year
...
INSERT INTO cov_cb_2014_us_state_500k(year, cb_2014_us_state_500k, areaname,
       total_poverty_all_ages,
	   pct_poverty_all_ages,
	   pct_poverty_0_17,
	   pct_poverty_related_5_17,
...
WITH a AS (
	...
	SELECT a.year, b.cb_2014_us_state_500k, b.areaname
	  FROM a CROSS JOIN lookup_cb_2014_us_state_500k b
)
/*
...
SELECT b.year, b.cb_2014_us_state_500k, b.areaname,
  ...
  FROM b
	LEFT OUTER JOIN saipe_state_poverty_1989_2015 c ON 
		(b.year = c.year AND b.cb_2014_us_state_500k = c.cb_2014_us_state_500k)
	LEFT OUTER JOIN saipe_state_poverty_1989_2015 c89 ON 
...
-- Convert to index organised table
--
CLUSTER cov_cb_2014_us_state_500k USING cov_cb_2014_us_state_500k_pkey;

COMMENT ON TABLE cov_cb_2014_us_state_500k
  IS 'Example covariate table for: The State at a scale of 1:500,000';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.year IS 'Year';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.cb_2014_us_state_500k IS 'Geolevel name';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.total_poverty_all_ages IS 'Estimate of people of all ages in poverty';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.pct_poverty_all_ages IS 'Estimate percent of people of all ages in poverty';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.pct_poverty_0_17 IS 'Estimated percent of people age 0-17 in poverty';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.pct_poverty_related_5_17 IS 'Estimated percent of related children age 5-17 in families in poverty';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.median_household_income IS 'Estimate of median household income';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.median_hh_income_quin IS 'Quintile: estimate of median household income (1=most deprived, 5=least)';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.med_pct_not_in_pov_quin IS 'Quintile: estimate percent of people of all ages NOT in poverty (1=most deprived, 5=least)';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.med_pct_not_in_pov_0_17_quin IS 'Quintile: estimated percent of people age 0-17 NOT in poverty (1=most deprived, 5=least)';
COMMENT ON COLUMN cov_cb_2014_us_state_500k.med_pct_not_in_pov_5_17r_quin IS 'Quintile: estimated percent of related children age 5-17 in families NOT in poverty (1=most deprived, 5=least)';

\copy cov_cb_2014_us_state_500k TO 'cov_cb_2014_us_state_500k.csv' WITH CSV HEADER;
\dS+ cov_cb_2014_us_state_500k
