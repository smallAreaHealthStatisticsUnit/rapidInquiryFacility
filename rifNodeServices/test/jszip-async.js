...
fs.readFile(fileName, function fileReaderCallback(err, data) {
	...
	var zip = JSZip();
	JSZip.loadAsync(data, {} /* Options */).then(function loadAsyncCallback(zip) { 
		// This does not work because loadAync is not yet a method in the distro version (see constructor line 573 in ..\rifNodeServices\node_modules\jszip\dist\jszip.js)
		// Current released version 2.6.0, expecting this will work with 3.0.0 
		var noZipFiles=0;
