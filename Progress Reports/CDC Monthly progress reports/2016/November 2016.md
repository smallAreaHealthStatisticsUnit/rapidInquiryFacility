...
|------|-------------------|--------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|------------------------------------------------|-----------------------------------------------------------|-------|
| 45   | 07 November 2016  | Map tile generation                                                      | Java handover, fix submission feature                                                             | Disease Mapping                                                                                | R data insert                                                       | Other SAHSU                                    |                                                           |       |
| 46   | 14 November 2016  | Map tile generation                                                      | Holiday                                                                                           | Disease Mapping                                                                                | Other SAHSU                                                         | Java handover                                  |                                                           |       |
| 47   | 21 November 2016  | Map tile generation                                                      | Java handover, fix submission failures                                                            | Disease Mapping                                                                                | R Posaterior probability                                            | SQL Server middleware                          | Results Viewer                                            |       |
| 48   | 28 November 2016  | SQL Server tile integration                                              | 7. Data Loader (35 days) - start liable for 2/3 weeks delays caused by more work on GET methods   | Allocated to JG                                                                                | Other SAHSU                                                         | Other SAHSU                                    |                                                           |       |
...
| 1    | 02 January 2017   | SQL Server study submission and data extraction; installer documentation | Data Loader (port to SQL Server)                                                                  | Documentation, manual                                                                          | Documentation, manual                                               | SQL Server middleware                          | Full end to end on Postgres, SQL Server front end logon   |       |
| 2    | 09 January 2017   | SQL Server tile integration                                              | Data Loader                                                                                       | SQL Server middleware                                                                          | Other SAHSU                                                         | SQL Server middleware                          |                                                           |       |
| 3    | 16 January 2017   | SQL Server data extract                                                  | Data Loader                                                                                       | Documentation, manual                                                                          | Documentation, manual                                               | SQL Server middleware                          |                                                           |       |
| 4    | 23 January 2017   | SQL Server data extract                                                  | Data Loader                                                                                       | SQL Server middleware                                                                          | Other SAHSU                                                         | SQL Server middleware                          | Data Loader                                               |       |
| 5    | 30 January 2017   | SQL Server data extract                                                  | Holiday                                                                                           | Documentation, manual                                                                          | Documentation, manual                                               | SQL Server middleware                          | Study submission and Results viewer running on SQL server |       |
