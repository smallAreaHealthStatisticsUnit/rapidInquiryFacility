                        ...
                        getModelInvestigation: function () {
                            if (s.terms.length !== 0) {
                                ...
                                thisInv.numerator_denominator_pair = {
                                    ...
                                    "denominator_table_name": SubmissionStateService.getState().numerator.denominatorTableName,
                                    "denominator_table_description": SubmissionStateService.getState().numerator.denominatorTableDescription
                                };
                                var uprGroup;
                                var lwrGroup;
