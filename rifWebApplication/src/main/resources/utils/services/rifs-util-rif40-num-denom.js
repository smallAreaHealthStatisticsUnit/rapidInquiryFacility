                    ...
                    initialiseRif40NumDenomService = function () {
                        return $q(function(resolve, reject) { // A promise
                            user.getRif40NumDenom(user.currentUser).then(
                                ...
                                function(err) {
                                    reject("getRif40NumDenom REST error: " + 
                                        (err ? JSON.stringify(err) : "N/A"));
                                });
                        });
                    }
                    return {
                        ...
                        getRif40NumDenom: function() {
                            if (rif40NumDenom == undefined) {
                                AlertService.showError("Rif40NumDenomService is not initialised");
                            }
                            return rif40NumDenom;
                        }
                    };
                }]);