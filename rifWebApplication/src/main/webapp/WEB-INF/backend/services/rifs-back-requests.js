...
angular.module("RIF")
        ...
        .service('user', ['$http', 'studySubmissionURL', 'studyResultRetrievalURL', 'taxonomyServicesURL', 'DatabaseService',
            function ($http, studySubmissionURL, studyResultRetrievalURL, taxonomyServicesURL, DatabaseService) {
                ...
                //switch for specific database type, pg or ms
                var submission = studySubmissionURL + DatabaseService.getDatabase() + "/";
                var retrieval = studyResultRetrievalURL + DatabaseService.getDatabase() + "/";
                ...
                self.submitStudy = function (username, jsonObj) {
                    ...
                    return $http.post(submission + "submitStudy/", formData, {
                ...
                self.login = function (username, password) {
                    ...
                    return $http.get(submission + 'login?userID=' + username + '&password=' + password);
                };
                ...
                self.getProjects = function (username) {
                    ...
                    return $http.get(submission + 'getProjects?userID=' + username, config);
                };
                self.getProjectDescription = function (username, projectName) {
                    ...
                    return $http.get(submission + 'getProjectDescription?userID=' + username + '&projectName=' + projectName, config);
                };
                self.getGeographies = function (username) {
                    ...
                    return $http.get(submission + 'getGeographies?userID=' + username, config);
                };
                self.getHealthThemes = function (username, geography) {
                    ...
                    return $http.get(submission + 'getHealthThemes?userID=' + username + '&geographyName=' + geography, config);
                };
                self.getNumerator = function (username, geography, healthThemeDescription) {
                    ...
                    return $http.get(submission + 'getNumerator?userID=' + username + '&geographyName=' + geography + "&healthThemeDescription=" + healthThemeDescription, config);
                };
                ...
                self.getYearRange = function (username, geography, numeratorTableName) {
                    ...
                    return $http.get(submission + 'getYearRange?userID=' + username + '&geographyName=' + geography + '&numeratorTableName=' + numeratorTableName, config);
                };
                self.getSexes = function (username) {
                    ...
                    return $http.get(submission + 'getSexes?userID=' + username, config);
                };
                self.getCovariates = function (username, geography, geoLevel) {
                    ...
                    return $http.get(submission + 'getCovariates?userID=' + username + '&geographyName=' + geography + '&geoLevelToMapName=' + geoLevel, config);
                };
                self.getAgeGroups = function (username, geography, numerator) {
                    ...
                    return $http.get(submission + 'getAgeGroups?userID=' + username + '&geographyName=' + geography + '&numeratorTableName=' + numerator, config);
                };
                //geography info
                self.getDefaultGeoLevelSelectValue = function (username, geography) {
                    ...
                    //[{"names":["LEVEL2"]}]
                    return $http.get(submission + 'getDefaultGeoLevelSelectValue?userID=' + username + '&geographyName=' + geography, config);
                };
                self.getGeoLevelViews = function (username, geography, geoLevelSelectName) {
                    ...
                    return $http.get(submission + 'getGeoLevelViews?userID=' + username + '&geographyName=' + geography +
                ...
                self.getGeoLevelSelectValues = function (username, geography) {
                    ...
                    return $http.get(submission + 'getGeoLevelSelectValues?userID=' + username + '&geographyName=' + geography, config);
                };
                //statistical methods
                self.getAvailableCalculationMethods = function (username) {
                    ...
                    return $http.get(submission + 'getAvailableCalculationMethods?userID=' + username, config);
                };
                //status
                self.getCurrentStatusAllStudies = function (username) {
                    ...
                    return $http.get(retrieval + 'getCurrentStatusAllStudies?userID=' + username, config);
                };
                //results for viewer
                self.getSmoothedResults = function (username, studyID, sex) {
                    ...
                    return $http.get(retrieval + 'getSmoothedResults?userID=' + username + '&studyID=' + studyID + '&sex=' + sex, config);
                };
                self.getAllPopulationPyramidData = function (username, studyID, year) {
                    ...
                    return $http.get(retrieval + 'getAllPopulationPyramidData?userID=' + username + '&studyID=' + studyID + '&year=' + year, config);
                };
                ...
                self.getYearsForStudy = function (username, studyID, leaflet) {
                    ...
                    return $http.get(retrieval + 'getYearsForStudy?userID=' + username + '&study_id=' + studyID, config);
                };
                self.getSexesForStudy = function (username, studyID, leaflet) {
                    ...
                    //[{"names":["Males","Females","Both"]}]
                    return $http.get(retrieval + 'getSexesForStudy?userID=' + username + '&study_id=' + studyID, config);
                };
                self.getGeographyAndLevelForStudy = function (username, studyID) {
                    ...
                    //[["SAHSU","LEVEL3"]]
                    return $http.get(retrieval + 'getGeographyAndLevelForStudy?userID=' + username + '&studyID=' + studyID);
                };
                ...
                self.getTileMakerTiles = function (username, geography, geoLevel) {
                    ...
                    return (retrieval + 'getTileMakerTiles?userID=' + username + '&geographyName=' + geography + '&geoLevelSelectName=' + geoLevel +
                            '&zoomlevel={z}&x={x}&y={y}');
                };
                //get 'global' geography for attribute table
                self.getTileMakerTilesAttributes = function (username, geography, geoLevel) {
                    return $http.get(retrieval + 'getTileMakerTiles?userID=' + username + '&geographyName=' + geography + '&geoLevelSelectName=' + geoLevel +
                ...
                self.getStudySubmission = function (username, studyID) {
                    ...
                    return $http.get(submission + 'getStudySubmission?userID=' + username + '&studyID=' + studyID);
                };
            }]);