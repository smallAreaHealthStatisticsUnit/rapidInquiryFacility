...
public final class PublishWorkflowConfiguration {
	...
	private String rifUserRoleName;
	
	// ==========================================
	// Section Construction
	// ==========================================

	private PublishWorkflowConfiguration(
		final DataSet dataSet) {		

	}

	public static PublishWorkflowConfiguration newInstance() {

		DataSet dataSet = DataSet.newInstance();
		PublishWorkflowConfiguration publishWorkflowFieldConfiguration
			= new PublishWorkflowConfiguration(dataSet);
			
		return publishWorkflowFieldConfiguration;
	}	
	...
	public static PublishWorkflowConfiguration createCopy(
		final PublishWorkflowConfiguration originalPublishConfiguration) {
		
		DataSet originalDataSet = originalPublishConfiguration.getDataSet();
		DataSet clonedDataSet = DataSet.createCopy(originalDataSet);
		
		PublishWorkflowConfiguration clonePublishWorkflowConfiguration
			= PublishWorkflowConfiguration.newInstance(clonedDataSet);
		clonePublishWorkflowConfiguration.setRIFUserRoleName(originalPublishConfiguration.getRIFUserRoleName());
		
		return clonePublishWorkflowConfiguration;		
	}
	...
	public String getRIFUserRoleName() {
		return rifUserRoleName;
	}
	
	public void setRIFUserRoleName(final String rifUserRoleName) {
		this.rifUserRoleName = rifUserRoleName;
	}
	...
	public String getDisplayName() {
		String tableName
			= RIFTemporaryTablePrefixes.PUBLISH.getTableName(
