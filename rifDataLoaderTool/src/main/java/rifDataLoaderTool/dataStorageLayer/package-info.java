 ...
 * In each of the main two <code>dataStorageLayer</code> packages of the data loader
 ...
 * human-readable message and throw a {@link rifGenericLibrary.system.RIFServiceException}.
 * and throw that.
 * </li>
 * <li>
 ...
 * {@link rifGenericLibrary.businessConceptLayer.RIFResultTable} that can store
 * results
 * </li>
 * <li>
