...
public class SQLQueryUtility {
	 ...
	 * @throws RIFDataLoaderToolException the RIF data loader tool exception
	 */
	public static void close(
		...
		try {
			...
			String errorMessage
				= RIFDataLoaderToolMessages.getMessage("sqlConnectionManager.error.unableToCloseResource");
			...
			RIFDataLoaderToolException rifDataLoaderToolException
				= new RIFDataLoaderToolException(
					RIFDataLoaderToolError.CLOSE_RESOURCE,
					errorMessage);
	 ...
	 * @throws RIFDataLoaderToolException the RIF service exception
	 */
	public static void close(
