...
final class RIFDataLoaderToolShutdownManager 
	...
	//Data
	/** The rif session. */
	private RIFDataLoaderToolSession rifDataLoaderToolSession;
	...
	public RIFDataLoaderToolShutdownManager(
		...
		final RIFDataLoaderToolSession rifDataLoaderToolSession) {
		
		this.parentDialog = parentDialog;
		parentDialog.addWindowListener(this);
		this.rifDataLoaderToolSession = rifDataLoaderToolSession;
	}
	...
	public void shutDown() {
		...
		String dialogTitle
			= RIFDataLoaderToolMessages.getMessage("shutDownDialog.title");
		String message
			= RIFDataLoaderToolMessages.getMessage("shutDownDialog.warningMessage");
		int result
