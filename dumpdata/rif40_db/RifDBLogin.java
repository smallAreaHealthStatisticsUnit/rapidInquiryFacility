...
public class RifDBLogin {
	...
	public static Connection rif_dbconnect() {
 
		Connection connection = null;
		Properties props = new Properties();

   	     	// set up new properties object from file "../../conf/RIFProperties.txt"
		...
		try {
        		propFile = new FileInputStream( "../conf/RIFProperties.txt");
		} catch (FileNotFoundException e) {

			System.out.println("Cannot find: ../conf/RIFProperties.txt");
			e.printStackTrace();
			return null;
		}
		...
		try {
			...
			System.out.println("Cannot load: ../conf/RIFProperties.txt");
			e.printStackTrace();
			return null;
		}
