...
public class SpecifyInvestigationsStepPanel 
	...
	private void buildUI() {
		...
		instructionsText.append(RIFJobSubmissionToolMessages.getMessage("specifyInvestigationsStepPanel.instructions3"));
