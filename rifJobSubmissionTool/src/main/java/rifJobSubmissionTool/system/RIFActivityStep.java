...
public enum RIFActivityStep {
	 ...
	 */
	public static RIFActivityStep getFirstActivityStep() {
	 ...
	 */
	public RIFActivityStep getPreviousActivityStep() {
		
		if (this == RIFActivityStep.CREATE_OR_COPY_STUDY_STEP) {
			return CREATE_OR_COPY_STUDY_STEP;
		}
		else if (this == RIFActivityStep.DESCRIBE_STUDY) {
			return CREATE_OR_COPY_STUDY_STEP;
		}
		else if (this == RIFActivityStep.CHOOSE_STUDY_AREA) {
			return DESCRIBE_STUDY;
		}
		else if (this == RIFActivityStep.CHOOSE_COMPARISON_AREA) {
			return CHOOSE_STUDY_AREA;
		}
		else if (this == RIFActivityStep.SPECIFY_INVESTIGATIONS) {
			return CHOOSE_COMPARISON_AREA;
		}
		else if (this == RIFActivityStep.SPECIFY_REPORTS){
	 ...
	 */
	public RIFActivityStep getNextActivityStep() {
