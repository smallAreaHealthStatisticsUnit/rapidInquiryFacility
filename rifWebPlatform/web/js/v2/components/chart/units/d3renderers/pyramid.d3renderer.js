RIF.chart.pyramid.d3renderer = (function( opt, data ){
	...
	/*var title = svg.append("text")
	  ...
	  var maxagegroup = d3.max(data, function(d) { return d.agegroup; }),
	      minagegroup = d3.min(data, function(d) { return d.agegroup; });
	  ...
	  var birthyear = birthyears.selectAll(".birthyear")
		...
		.enter().append("g")
		  ...
		  .attr("transform", function(agegroup) {return "translate(0," + y(agegroup.agegroup) + ")"; });
    ...
    svg.selectAll(".age")
		...
		.enter().append("text")
		  .attr("class", "age")
		  .attr("y", function(agegroup) { return y(agegroup.agegroup) - 7; })
		  .attr("x", - 20)
		  .attr("fill", "#8F8F8F")
		  .attr("dy", ".9em")
		  .text(function(agegroup) { return agegroup.minage + '-' + agegroup.maxage; });
