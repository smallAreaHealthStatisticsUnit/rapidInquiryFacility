   ...
   var style = this,
      ...
      scales = {
         ...
         jenks: function() {
            ...
            jenks.shift();
            var l = jenks.length;
            var j = d3.scale.threshold().domain(jenks).range(d3.range(intervals).map(function(i) {
               return i
            }));
            return j;
         },
         ...
         standardDeviation: function() {
            ...
            var j = d3.scale.threshold().domain(breaks).range(d3.range(intervals).map(function(i) {
               return i
            }));
            setBreaks(j, 'yesMin');
            return j;
