RIF.chart.line_bivariate.d3renderer = ( function ( opt, data, svgElement ) {
  ...
  var svg = d3.select( "#" + id ).insert( "svg", "div" ).attr( "width", width ).attr( "height", height );
  ...
  focus.append( "g" ).attr( "class", "y axis" ).call( yAxis ).append( "text" ).attr( "x", 30 ).attr( "y", 2 ).attr( "style", "text-transform:uppercase" ).attr( "dy", ".4em" ).style( "text-anchor", "end" ).style( "fill", "#919191" ).attr( "transform", "translate(5,5)" ).text( lineField );
  focus.append( "path" ).datum( data ).attr( "class", "line" ).attr( "d", line );
  context.append( "g" ).attr( "class", "x axis" ).attr( "transform", "translate(0," + height + ")" ).call( xAxis2 );
  context.append( "g" ).attr( "class", "x brush" ).call( brush ).selectAll( "rect" ).attr( "y", -6 ).attr( "height", height + 7 );
  /*svg.append('g')
