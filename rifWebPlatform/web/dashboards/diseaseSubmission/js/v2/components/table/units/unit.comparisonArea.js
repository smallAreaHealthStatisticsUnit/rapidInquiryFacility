RIF['table']['unit-comparisonArea'] = (function (_dom, tableUtils) {
  ...
  var _p = {
    getTabularData: function (data) {
      var fragment = tableUtils.renderTable(data, 'comparisonArea', _dom.selectionClass);
      _show(fragment);
    },
    ...
    getTabularDataFromMap: function (data) {
      var fragment = tableUtils.addSelected(data, 'comparisonArea', _dom.selectionClass);
      _show(fragment);
