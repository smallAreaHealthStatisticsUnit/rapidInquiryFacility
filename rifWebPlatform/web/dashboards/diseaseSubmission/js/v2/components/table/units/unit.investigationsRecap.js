RIF.table.investigationsRecap = ( function ( _dom ) {
  ...
  var addRow = function ( params ) {
      ...
      $( tr ).html( '<td class="taxonomiRow">' + taxonomies + '</td>' + '<td class="healthOutcomesRow">' + healthOutcomes + '</td>' + '<td class="agegroupsRow"><p>' + ageGroups + '</p></td>' + '<td class="yearRow"><p>' + data.minYear + '-' + data.maxYear + '</p></td>' + '<td class="genderRow"><p>' + data.gender + '</p></td>' + '<td class="covariatesRow"><p>' + covariates + '</p></td>' + '<td class="removeInvestigation"><p></p></td>' );
