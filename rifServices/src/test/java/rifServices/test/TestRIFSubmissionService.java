...
public class TestRIFSubmissionService extends ProductionRIFJobSubmissionService {
	...
	public TestRIFSubmissionService() {
	...
	public void checkNonExistentAgeGroups(
		...
		super.checkNonExistentAgeGroups(user, ageBands);
	...
	public void checkNonExistentCovariates(
		...
		super.checkNonExistentCovariates(user, covariates);
	}
