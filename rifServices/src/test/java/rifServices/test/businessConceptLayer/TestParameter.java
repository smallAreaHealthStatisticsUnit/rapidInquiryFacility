...
public class TestParameter extends AbstractRIFTestCase {
	...
	private Parameter masterParameter;
	...
	public void testSecurityViolations() {
		...
		maliciousParameter
			= Parameter.createCopy(masterParameter);
		maliciousParameter.setName(getTestMaliciousValue());
		try {
			maliciousParameter.checkSecurityViolations();
			fail();
		}
		...
		maliciousParameter
			= Parameter.createCopy(masterParameter);
		maliciousParameter.setValue(getTestMaliciousValue());
		try {
			maliciousParameter.checkSecurityViolations();
			fail();
		}
