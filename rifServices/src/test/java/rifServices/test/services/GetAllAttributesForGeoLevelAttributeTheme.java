...
public final class GetAllAttributesForGeoLevelAttributeTheme 
	...
	public GetAllAttributesForGeoLevelAttributeTheme() {
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_COMMON1() {
		try {
			 ...
			 */
			String[] results
				= rifStudyRetrievalService.getAllAttributesForGeoLevelAttributeTheme(
					validUser, 
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_EMPTY1() {
		try {
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_NULL1() {
		try {
			StudyResultRetrievalContext validStudyResultRetrievalContext
				= cloneValidResultContext();
			GeoLevelAttributeSource validGeoLevelAttributeSource
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_EMPTY2() {
		try {
			User validUser = cloneValidUser();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_NULL2() {
		try {
			User validUser = cloneValidUser();
			GeoLevelAttributeSource validGeoLevelAttributeSource
				= cloneValidGeoLevelAttributeSource();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_EMPTY3() {
		try {
			User validUser = cloneValidUser();
			StudyResultRetrievalContext validStudyResultRetrievalContext
				= cloneValidResultContext();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_NULL3() {
		try {
			User validUser = cloneValidUser();
			StudyResultRetrievalContext validStudyResultRetrievalContext
				= cloneValidResultContext();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_EMPTY4() {
		try {
			User validUser = cloneValidUser();
			StudyResultRetrievalContext validStudyResultRetrievalContext
				= cloneValidResultContext();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_NULL4() {
		try {
			User validUser = cloneValidUser();
			StudyResultRetrievalContext validStudyResultRetrievalContext
				= cloneValidResultContext();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_NONEXISTENT1() {
		try {
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_NONEXISTENT2() {
		try {
			User validUser = cloneValidUser();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_NONEXISTENT3() {
		try {
			User validUser = cloneValidUser();
			StudyResultRetrievalContext validStudyResultRetrievalContext
				= cloneValidResultContext();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_NONEXISTENT4() {
		try {
			User validUser = cloneValidUser();
			StudyResultRetrievalContext validStudyResultRetrievalContext
				= cloneValidResultContext();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_MALICIOUS1() {
		try {
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_MALICIOUS2() {
		try {
			User validUser = cloneValidUser();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_MALICIOUS3() {
		try {
			User validUser = cloneValidUser();
			StudyResultRetrievalContext validStudyResultRetrievalContext
				= cloneValidResultContext();
	...
	@Test
	public void getAllAttributesForGeoLevelAttributeTheme_MALICIOUS4() {
		try {
			User validUser = cloneValidUser();
			StudyResultRetrievalContext validStudyResultRetrievalContext
				= cloneValidResultContext();
