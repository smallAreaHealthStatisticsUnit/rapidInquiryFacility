	...
	*/
	...
	protected void initialiseService() throws RIFServiceException {
		...
		rifStudySubmissionService 
			= (PGSQLTestRIFStudySubmissionService) rifServiceBundle.getRIFStudySubmissionService();
		rifStudyRetrievalService
			= (PGSQLTestRIFStudyRetrievalService) rifServiceBundle.getRIFStudyRetrievalService();
	}
	
	protected PGSQLTestRIFStudyServiceBundle getRIFServiceBundle() {
