...
public class GetExtractResultsByBlock extends AbstractRIFServiceTestCase {
	...
	public GetExtractResultsByBlock() {
	...
	public void getCalculatedResultsByBlock_COMMON1() {
		try {
			...
			RIFResultTable result
				= rifStudyRetrievalService.getExtractResultsByBlock(
					validUser, 
					validStudySummary, 
