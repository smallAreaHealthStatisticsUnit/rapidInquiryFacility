...
final public class NumeratorDenominatorPairProxyConverter
	...
	public NumeratorDenominatorPairProxyConverter() {
	...
	public NumeratorDenominatorPair unmarshal(final NumeratorDenominatorPairProxy ndPairProxy) {
		...
		ndPair.setNumeratorTableDescription(ndPairProxy.getNumeratorTableDescription());
		ndPair.setDenominatorTableName(ndPairProxy.getDenominatorTableName());
		ndPair.setDenominatorTableDescription(ndPairProxy.getDenominatorTableDescription());
