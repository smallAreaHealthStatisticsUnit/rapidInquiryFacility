...
public class PGSQLInMemoryTileCache {
	...
	private static final PGSQLInMemoryTileCache inMemoryTileCache = new PGSQLInMemoryTileCache();
	...
	private PGSQLInMemoryTileCache() {
		tileResultFromKey = new HashMap<String, String>();
		agingKeys = new LinkedList<String>();
	}

	public static PGSQLInMemoryTileCache getInMemoryTileCache() {
