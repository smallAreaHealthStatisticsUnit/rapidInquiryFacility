...
public class SQLResultsQueryManager extends AbstractSQLManager {
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_BOUNDS_FOR_AREA, 
					errorMessage);
	...
	public Rectangle2D.Double getGeoLevelFullExtentForStudy(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_EXTENT_FOR_STUDY, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	public Rectangle2D.Double getGeoLevelFullExtent(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_EXTENT_FOR_GEOLEVEL, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	public String getTiles(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_TILES,
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	public RIFResultTable getCalculatedResultsByBlock(
		...
		try {
			...
			RIFServiceException rifServiceException	
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_RESULTS_BY_BLOCK, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	private String getCalculatedResultTableName(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_CALCULATED_RESULTS_TABLE_FOR_STUDY, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	public ArrayList<MapAreaAttributeValue> getMapAreaAttributeValues(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_MAP_AREA_VALUES_FOR_ATTRIBUTE, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	public ArrayList<GeoLevelAttributeTheme> getGeoLevelAttributeThemes(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_GEO_LEVEL_ATTRIBUTE_THEMES, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	public String[] getAllAttributesForGeoLevelAttributeTheme(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_ATTRIBUTES_FOR_RESULT_ATTRIBUTE_THEME,
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	public String[] getNumericAttributesForGeoLevelAttributeTheme(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_GET_NUMERIC_ATTRIBUTES_FOR_RESULT_ATTRIBUTE_THEME,
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	private void checkResultsTableExists(
		...
		try {			
			...
			RIFServiceException rifServiceException
				 = new RIFServiceException(
					RIFServiceError.UNABLE_TO_CHECK_RESULT_TABLE_EXISTS,
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	private void checkResultsTableFieldExists(
		...
		try {
			...
			RIFServiceException rifServiceException	
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_CHECK_RESULT_TABLE_FIELD_EXISTS, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	private void checkMapAreaExists(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_CHECK_MAP_AREA_EXISTS, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	private void checkGeoLevelAttributeExists(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_CHECK_GEO_LEVEL_ATTRIBUTE_EXISTS, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
	...
	private void checkGeoLevelAttributeThemeExists(
		...
		try {
			...
			RIFServiceException rifServiceException
				= new RIFServiceException(
					RIFServiceError.UNABLE_TO_CHECK_GEO_LEVEL_ATTRIBUTE_THEME_EXISTS, 
					errorMessage);
			throw rifServiceException;
		}
		finally {
