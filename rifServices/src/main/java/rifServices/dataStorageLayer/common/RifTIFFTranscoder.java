...
/* Fix for http://batik.2283329.n4.nabble.com/TiffTranscoder-cannot-find-TIFF-WriteAdapter-td4657001.html
 *
 * Source: http://www1.udel.edu/CIS/software/dist/batik-src/xml-batik/sources/org/apache/batik/transcoder/image/TIFFTranscoder.java
 */
 ...
 * @version $Id: TIFFTranscoder.java 378233 2006-02-16 12:28:25Z deweese $
 */
public class RifTIFFTranscoder extends ImageTranscoder {

    /**
     * Constructs a new transcoder that produces tiff images.
     */
    public RifTIFFTranscoder() { 
    ...
    public void writeImage(BufferedImage img, TranscoderOutput output)
        ...
        if (adapter == null) {
            throw new TranscoderException(
                    "Could not write TIFF file because no WriteAdapter is available"); // Also fixed the typo!
        }
    ...
    public interface WriteAdapter {
         ...
         * @throws TranscoderException if an error occured while storing the image
         */
        void writeImage(RifTIFFTranscoder transcoder, BufferedImage img, 
