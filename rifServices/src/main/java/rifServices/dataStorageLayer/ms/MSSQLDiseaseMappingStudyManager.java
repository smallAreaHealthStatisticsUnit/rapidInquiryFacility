...
final class MSSQLDiseaseMappingStudyManager extends AbstractSQLManager
		implements DiseaseMappingStudyManager {

	private Messages GENERIC_MESSAGES = Messages.genericMessages();
	
	private RIFContextManager rifContextManager;
	private MSSQLInvestigationManager investigationManager;
	...
	public ArrayList<Project> getProjects(
		...
		try {
			...
			rifLogger.error(
					MSSQLDiseaseMappingStudyManager.class, 
				errorMessage, 
				sqlException);
