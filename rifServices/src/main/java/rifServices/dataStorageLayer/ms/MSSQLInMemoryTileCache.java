...
public class MSSQLInMemoryTileCache {
	...
	private static final MSSQLInMemoryTileCache inMemoryTileCache = new MSSQLInMemoryTileCache();
	...
	private MSSQLInMemoryTileCache() {
		tileResultFromKey = new HashMap<String, String>();
		agingKeys = new LinkedList<String>();
	}

	public static MSSQLInMemoryTileCache getInMemoryTileCache() {
