 ...
 * support two studies: a {@link rifServices.businessConceptLayer.DiseaseMappingStudy} and a risk analysis study.
 ...
 * <li>a {@link rifServices.businessConceptLayer.Geography}, which describes the data source for geographic information</li>
 * <li>a study area - {@link rifServices.businessConceptLayer.DiseaseMappingStudyArea} or 
 * in future a RiskAnalysisStudyArea.  The study area defines the area that a scientific activity will examine
 * </li>
 * <li>a {@link rifServices.businessConceptLayer.ComparisonArea}.  The incidence of disease found in the study area
 * will be compared to the incidence found in a population in a more general area.</li> 
 * <li>a collection of {@link rifServices.businessConceptLayer.Investigation} objects, which describe specific
 ...
 * <ul>
 * <li>
 * {@link rifServices.businessConceptLayer.AbstractStudy}
 * </li>
 * <li>
 * {@link rifServices.businessConceptLayer.DiseaseMappingStudy}
 * </li>
 * </ul>
 ...
 * <li>{@link rifServices.businessConceptLayer.DiseaseMappingStudyArea}</li>
 * </ul>
 * 
 * <p>
 ...
 * </li>
 * <li>
 * {@link rifServices.businessConceptLayer.GeoLevelToMap}: the resolution used for the maps that are produced from
 * the extraction results.
 * </li>
 * <li>a collection of {@link rifServices.businessConceptLayer.MapArea} objects: each map area is defined by an
 ...
 * <ul>
 * <li>{@link rifServices.businessConceptLayer.HealthTheme}: describes the theme of health data (eg: "cancer"). Each
 ...
 * <li>a set of {@link rifServices.businessConceptLayer.AgeBand} objects: An age band could be age 20 - 40.  Each age
 ...
 * <li>
 * a collection of {@link rifServices.businessConceptLayer.AbstractCovariate} objects: describe the factors which 
 ...
 * 
 * <p>
 * The other main area will be the development of {@link rifServices.businessConceptLayer.AdjustableCovariate} and
 * {@link rifServices.businessConceptLayer.ExposureCovariate}.  Currently, the RIF requires that all covariates are
