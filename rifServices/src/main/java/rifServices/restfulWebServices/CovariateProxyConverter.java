...
public class CovariateProxyConverter 
	...
	public CovariateProxyConverter() {
	...
	public CovariateProxy marshal(final AdjustableCovariate covariate) {
		...
		covariateProxy.setCovariateType(covariate.getCovariateType().getName());
	...
	public AdjustableCovariate unmarshal(final CovariateProxy covariateProxy) {
		...
		CovariateType covariateType
			= CovariateType.getTypeFromName(covariateProxy.getCovariateType());
		covariate.setCovariateType(covariateType);
		covariate.setName(covariateProxy.getName());
		covariate.setMinimumValue(covariateProxy.getMinimumValue());
		covariate.setMaximumValue(covariateProxy.getMaximumValue());
