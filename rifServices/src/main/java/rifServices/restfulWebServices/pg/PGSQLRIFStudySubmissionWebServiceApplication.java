...
@ApplicationPath("/studySubmission/pg")
public class PGSQLRIFStudySubmissionWebServiceApplication extends Application {
	...
	public Set<Class<?>> getClasses() {
		...
		set.add(PGSQLRIFStudySubmissionWebServiceResource.class);
