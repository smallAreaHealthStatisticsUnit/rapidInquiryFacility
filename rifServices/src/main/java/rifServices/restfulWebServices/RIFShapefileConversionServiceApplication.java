...
@ApplicationPath("/shapeFileConverter")
public class RIFShapefileConversionServiceApplication extends Application {
	...
	public RIFShapefileConversionServiceApplication() {
