...
public class CalculationMethodProxy {
	...
	private String description;
 	...
 	@XmlElement(required = true)		
	private ArrayList<ParameterProxy> parameterProxies;	
	...
	public ArrayList<ParameterProxy> getParameterProxies() {
