...
@ApplicationPath("/studySubmission/ms")
public class MSSQLRIFStudySubmissionWebServiceApplication extends Application {
	...
	public MSSQLRIFStudySubmissionWebServiceApplication() {
		rifLogger = RIFLogger.getLogger();
		rifLogger.info(this.getClass(), "!!!!!!!!!!!!!!!!!!!!! MSSQLRIFStudySubmissionWebServiceApplication !!!!!!");
	}
	...
	public Set<Class<?>> getClasses() {
		...
		set.add(MSSQLRIFStudySubmissionWebServiceResource.class);
