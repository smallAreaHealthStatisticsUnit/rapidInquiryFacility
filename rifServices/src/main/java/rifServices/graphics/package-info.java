 ...
 * "API":
 * <ul>
 * <li>{link rifServices.dataStorageLayer.RIFStudyServiceAPI}</li>
 * <li>{link rifServices.dataStorageLayer.RIFStudySubmissionAPI}</li>
 * <li>{link rifServices.dataStorageLayer.RIFStudyResultRetrievalAPI}</li>
 * </ul>
 * 
 * <p>
