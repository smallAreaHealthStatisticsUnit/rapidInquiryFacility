...
- [2.1 Screen Shots](#3-screen-shots)
...
The invesitgation. This shows an investigation being setup.
...
The study is then subbmitted. It is checked and then saved in the database and a procedure called to extract the required data. This is then 
...
Finally, tje userr can export the study data for further analysis and inclusion in papers and reports.
...
* The US Center for Disease Control (CDC) as part of the [US] [Environment and Health Public Tracking 
  Program](http://www.cdc.gov/nceh/tracking).  As an example, the State of Utah Department of Health used the RIF to investigate the 
  perceived excess of leukaemia in relation to oil refineries in Utah [3].  The CDC support enabled modifications to the RIF to increase 
  its functionality, ease of use and versatility.
* ![The National Institute for Health Research Health Protection Research Unit](http://www.nihr.ac.uk/)

## 4.1 Collaborators

* ![The US Centers for Disease Control and Prevention (CDC)](http://www.cdc.gov/)
* ![The National Institute for Health Research Health Protection Research Unit](http://www.nihr.ac.uk/)

## 4.2 Other Contributors

* ![The European Commission has supported previous RIF versions](http://ec.europa.eu/)
* ![Public Health England (PHE)](https://www.gov.uk/government/organisations/public-health-england)

## 5. Licensing

The RIF is licensed GNU LESSER GENERAL PUBLIC LICENSE and is freely available from 
[RIF GitHub](https://github.com/smallAreaHealthStatisticsUnit/rapidInquiryFacility)
