...
public final class PGSQLExportTableToCSVQueryFormatter
	 ...
	 */
	public PGSQLExportTableToCSVQueryFormatter() {
		tableToExport = "";
		outputFileName = "";
		delimiters = ",";
	}
	 ...
	 */
	public void setTableToExport(
		final String tableToExport) {
